export default {
  ...
  newUserGuide: {
    ...
    steps: {
      ...
      knowledge: {
        ...
        desc: 'Everything starts here: upload documents, web pages or FAQs and StarKB parses and indexes them automatically. Click here to open knowledge bases.'
      },
      chat: {
  ...
  knowledgeBase: {
    ...
    graphBadge: {
      ...
      tip: {
        none: 'No knowledge graph yet — this document is not used for graph retrieval',
        pending: 'Queued, waiting for the background builder',
        building: 'Building the knowledge graph',
        ready: 'Knowledge graph is ready and used for graph retrieval',
        failed: 'Graph build failed — click to see why and retry',
        stale: 'Document changed, the graph needs rebuilding',
        deleting: "Removing this document's graph data",
      },
      errorTitle: 'Build failure reason',
      unknownError: 'No reason recorded',
      attempts: 'Retried {n} times',
      retry: 'Retry',
      retrying: 'Submitting',
    },
    columnName: 'Name',
  ...
  settings: {
    ...
    sandbox: {
      ...
      backendDescriptions: {
        ...
        docker: 'Keep a long-lived container per session on this StarKB host; scripts and files stay in that container',
      },
      ...
      dockerHostRisk: 'Empty or unix:// uses the Docker daemon on the StarKB host, which is equivalent to root on that machine. Use this only for a private single-node install. Prefer Cube or E2B when multiple workspaces share a host. Remote tcp:// endpoints require a TLS certificate directory.',
      ...
      templateLoadHint: 'Enter the cluster connection and refresh. Missing StarKB CLI templates are built from the official Hub image. Desktop templates are larger; create them from the row below. After changing DNS or the image, rebuild from that card.',
      ...
      templateUntaggedHint: 'The builds finished but none carries the default tag, so sandbox creation cannot resolve this template. Delete it in E2B and refresh; StarKB will rebuild it.',
      templateFailedReason: 'Build failed: {reason}',
      noTemplates: 'No templates were returned by this cluster.',
      weknoraStandardTemplate: 'StarKB standard template',
      ...
      weknoraDesktopTemplate: 'StarKB desktop template',
      ...
      replaceStandardTemplateConfirm: 'Rebuild the StarKB standard template with the current settings, including DNS. The previous spawnable template is not deleted until the replacement is ready.',
      desktopTemplateProvisioning: 'The StarKB desktop template is being created. Refresh shortly to see its status.',
      ...
      replaceDesktopTemplateConfirm: 'Rebuild the StarKB desktop template with the current settings, including DNS. The previous spawnable desktop template is not deleted until the replacement is ready. The CLI template is left untouched.',
  ...
  envVarSettings: {
    ...
    description: 'Personal keys for skills and sandboxes, not StarKB system or deployment settings.',
  ...
  knowledgeGraph: {
    ...
    refresh: 'Refresh',
    loading: 'Loading…',
    empty: 'No graph data for this knowledge base yet',
    unavailable: 'Graph data unavailable',
    selectHint: 'Select a node to see entity details',
    truncatedNodes: 'Many nodes — showing the top {shown} by degree (of {total})',
    entityType: 'Type',
    degree: 'Connections',
    noDescription: '(no description)',
    neighbors: 'Related entities',
    neighborsEmpty: 'No related entities',
    evidence: 'Evidence',
    ...
    mergeInto: 'Merge into another entity',
    mergeTitle: 'Merge "{name}"',
    mergeConfirm: 'Merge',
    mergeWarning: 'Merging transfers relations and descriptions into the target entity and deletes this one. This cannot be undone.',
    mergeTargetPlaceholder: 'Search a target entity, or type a new name to rename',
    healthTitle: 'Graph data health',
    healthIssues: '{n} docs failed to build',
    healthFailed: 'Failed builds ({n})',
    healthRetry: 'Retry',
    healthNone: 'No issues',
    healthOrphans: 'Orphan evidence scan',
  ...
  graphSettings: {
    ...
    buildModelLabel: 'Graph build model',
    buildModelDescription: 'Model used for graph extraction. Clear = follow the knowledge base model; batch extraction is throughput-sensitive, so a fast / non-thinking model can be set here.',
    buildModelFollowKb: 'Follow the knowledge base model',
    graphViewLabel: 'Graph visualization',
    graphViewEmpty: 'No graph data for this knowledge base yet',
    openExplorer: 'Open graph explorer',
    coverageTitle: 'Graph coverage',
    coverageDescription: 'Graph build progress across buildable documents (paste-type documents carry no contract semantics and are excluded)',
    coverageReady: '{ready} of {eligible} documents graphed',
    coveragePending: '{n} queued or building',
  ...
  createChat: {
    title: 'Hi, I am StarKB — your knowledge, within reach',
  ...
  embedPublish: {
    ...
    originsHint: 'Enter the host websites allowed to embed this channel (A), not the StarKB address (B). One full origin per line, e.g. https://shop.example.com; at least one required. Supports *.example.com.',
  ...
  knowledgeEditor: {
    ...
    wikiBrowser: {
      ...
      tabGraph: 'Graph',
      tabGraphTip: 'A graph of links between Wiki pages (page-link graph). This is NOT the same as the LLM-extracted entity-relationship knowledge graph in the knowledge graph explorer (KB settings → Open graph explorer).',
  ...
  chat: {
    ...
    provenance: {
      title: 'Provenance',
      badge: 'Provenance',
      empty: 'Provenance data was not delivered with this message. Details will appear here once the contract alignment layer records block anchors.',
      source: 'Source',
      channel: 'Channel',
      reliability: 'Reliability',
      reliabilityAria: 'Source reliability {level} / 5',
      ...
      location: 'Location',
      pageItem: 'Page {page}',
      noPages: 'No pages delivered',
      chunk: 'Chunk anchors',
      anchorCount: 'Matched anchors',
      anchorCountValue: '{count} blocks',
      noAnchors: 'No anchors delivered',
      method: 'Alignment method',
      method_exact: 'Exact alignment',
      method_fuzzy: 'Fuzzy alignment',
  ...
  model: {
    ...
    editor: {
      ...
      reasoningEffortLabel: 'Thinking mode & effort',
      reasoningEffortPlaceholder: 'Follow the model default',
      reasoningEffortDesc: 'Model-level default: disable thinking or tune its effort (narrowed automatically to the levels the vendor supports). An explicit setting on an agent/session takes precedence.',
      thinkingBudgetLabel: 'Thinking budget (tokens)',
      thinkingBudgetPlaceholder: 'Vendor default',
      thinkingBudgetDesc: 'Caps thinking tokens per request; only honored by vendors exposing a budget field (Anthropic / DashScope / Gemini, etc.).',
      reasoning: {
        off: 'Off',
        minimal: 'Minimal',
        low: 'Low',
      ...
      embedTuningLabel: 'Embedding tuning',
      embedBatchSize: 'Embed batch size',
      embedRetryAttempts: 'Rate-limit retries',
      embedRetryBaseDelayMs: 'Retry base delay (ms)',
      embedRateLimitDelayMs: 'Rate-limit delay floor (ms)',
      embedTuningDefault: 'Default',
      embedTuningDesc: 'Tames 429s from rate-limit-sensitive providers (e.g. Ark plan account-level RPM) during background vectorization. Leave empty for defaults (batch 5, 8 retries, 2s base, ≥10s rate-limit delay).',
  ...
  integrations: {
    ...
    api: {
      ...
      hmacSecretDesc: 'Same secret stored in StarKB; used only on your backend to sign JWTs—never send it as a request header.',
    ...
    chrome: {
      ...
      subtitle: 'For self-hosted StarKB: ask questions in a sidebar, clip web pages, and save Markdown notes into your knowledge bases while you browse.',
      ...
      steps: {
        ...
        port: {
          ...
          desc: 'On StarKB Desktop, set a fixed API port (e.g. 37841) in API Info so the URL stays stable across restarts.'
        },
        install: {
    ...
    claw: {
      title: 'StarKB Skill',
      subtitle: 'Import documents and run hybrid retrieval (vector + keyword) via the StarKB REST API—for uploads, URL imports, Markdown entries, and cross-KB search.',
      ...
      installCtaHint: 'Install StarKB Skill · opens in a new tab',
