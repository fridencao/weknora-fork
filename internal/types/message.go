...
type Message struct {
	...
	// ClaimReport is the WS3.3 answer-level claim audit (M3 G4); persisted in
	// completeAssistantMessage when STARKB_CLAIM_GATE is enabled, nil otherwise.
	ClaimReport *ClaimReport `json:"claim_report,omitempty" gorm:"type:jsonb;column:claim_report"`
