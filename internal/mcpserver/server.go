// Package mcpserver hosts StarKB's own MCP server surface: the Streamable
...
const serverInstructions = "StarKB knowledge workspace. Start with list_knowledge_bases to see what is in scope, " +
